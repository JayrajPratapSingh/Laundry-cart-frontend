...
const Pastorder = () => {
  ...
  const gettingData = async () => {
    await fetch("https://laundry-cart-server.vercel.app/getOrder", {
  ...
  const deleteOrder = () => {
    ...
    fetch("https://laundry-cart-server.vercel.app/deleteOrder/" + orderId, {
      method: "DELETE",
      headers: {
        authtoken: token,
      },
  ...
  const changeHandler = (id) => {
    setVisible(!Visible);
    setorderId(id);
    fetch(`https://laundry-cart-server.vercel.app/order/${id}`, {
      method: "GET",
      headers: {
        authtoken: token,
      },
